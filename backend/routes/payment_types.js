...
function getConnection() {
  ...
  router.get("/", (req,res) => {
    ...
    connection.query(queryString, (error, rows, fields) => {
      ...
      const payment_types = rows.map((row) => {
        return {
          id: row.id,
  ...
  router.post("/create", (req, res) => {
    ...
    const queryString = "INSERT INTO payment_types (type_name) VALUES (?)"
  ...
  router.delete("/delete/:id", (req, res) =>{
    ...
    const queryString = "DELETE FROM payment_types WHERE id = ?"
  ...
  router.put("/update/:id", (req, res) => {
    ...
    const queryString = "UPDATE payment_types SET type_name = ? WHERE id = ?"
